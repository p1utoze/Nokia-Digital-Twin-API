# Nokia Digital Twin API

This is an API service for the Nokia Digital Twin project. It is based on the FastAPI framework and serves as the backend for the Nokia Digital Twin project. It has been used from fastapi's boilerplate code with following features:
